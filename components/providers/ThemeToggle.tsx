...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative m-4 h-9 w-9 rounded-md border border-border bg-background hover:bg-accent hover:text-accent-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
